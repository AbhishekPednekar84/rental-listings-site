            ...
            {!selectedApartment && (
              <>
                ...
                <div className="p-3">
                  ...
                  <div
                    className={`relative ${
                      props.touched.name && props.errors.name ? "mb-1" : "mb-12"
                    }`}
                  >
                    <Field
                      id="name"
                ...
                <div className="mb-5 flex h-[150px] justify-center overflow-y-auto bg-gradient-to-r from-slate-100 to-zinc-100">
                  <div className="w-80 p-2">
                    ...
                    <h5 className="mb-3 text-xs leading-5">
                      We found{" "}
                      {singleSearchResult ? "an apartment" : "some apartments"}{" "}
            ...
            <div className="flex justify-center">
              ...
              {!selectedApartment &&
                ...
                searchResults.length === 0 && (
                  <p className="font-semibold text-teal-800">Almost there...</p>
                )}

              {!selectedApartment && searchResults && searchResults.length > 0 && (
                <button
                  type="button"
