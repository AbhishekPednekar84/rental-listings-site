...
const ApartmentListingsHeadLayout = ({
  apartmentName,
  apartmentInfo,
  children,
}) => {
          ...
          dangerouslySetInnerHTML={{
            __html: `[
              ...
              },
              {
                ...
                "url": ${
                  '"' +
                  "https://rentorsale.apartments/listings/" +
                  { apartmentName } +
                  '"'
                } ,
                "description":
                  ${
                    '"' +
                    "Find flats for rent or sale in" +
                    apartmentName +
                    ". We provide a quick and easy way for owners to list their flats for rent or sale. Want to know if there is a flat for rent in" +
                    { apartmentName } +
                    "? Just search for " +
                    { apartmentName } +
                    " and find out!" +
...
export default ApartmentListingsHeadLayout;
