...
import CommonHeadLayout from "@/components/layout/head/CommonHeadLayout";

const ChangePasswordHeadLayout = (props) => {
  return (
    <Fragment>
      <CommonHeadLayout />
      <Head>
        <title>Change Your Password | rentorsale.apartments</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Change Your Password" />
        <meta
            ...
            __html: `[
              ...
              },
              {
                ...
                "potentialAction": {
                  ...
                  "target": {
                    "@type": "EntryPoint",
                    "urlTemplate": "https://rentorsale.apartments/forgotpassword"
                  }
                }
              }
            ]`,
...
export default ChangePasswordHeadLayout;
