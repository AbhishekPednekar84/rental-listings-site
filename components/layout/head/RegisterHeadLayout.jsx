...
const RegisterHeadLayout = (props) => {
  return (
    <Fragment>
      <CommonHeadLayout />
      <Head>
        <title>Sign Up | rentorsale.apartments</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Sign up for a rentorsale.apartments account"
        />
        <meta
          ...
          dangerouslySetInnerHTML={{
            __html: `[
              ...
              },
              {
                ...
                "url": "https://rentorsale.apartments/account/register",
                "description":
                  "Find flats for rent or sale in your dream apartment. We provide a quick and easy way for owners to list their flats for rent or sale. Want to know if there is a flat for rent in that apartment you have in mind? Just search for the name of the apartment and find out!",
                ...
                "potentialAction": {
                  ...
                  "target": {
                    "@type": "EntryPoint",
                    "urlTemplate": "https://rentorsale.apartments/account/register"
                  }
                }
              }
            ]`,
