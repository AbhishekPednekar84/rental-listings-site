...
import { loaderIcon, errorIcon, rupeeIcon } from "@/utils/icons";
...
const AddListing = ({ apartment }) => {
  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-br from-zinc-50 via-slate-100 to-neutral-200">
      <div className="mx-5 mt-32 mb-20 max-w-[480px] overflow-hidden bg-white shadow-xl">
        <div className="relative h-52 bg-createListingHero bg-cover bg-center md:h-64">
          {/* <svg
          ...
          <svg
            className="absolute -bottom-4 -right-1 lg:-bottom-7"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1440 320"
          >
            <path
        ...
        <div className="bg-white px-2 pt-8 md:px-10">
          <h1 className="mb-5 text-center font-bold leading-normal">
            <span className="heading-underline">Cr</span>
            eate Listing
          </h1>
          <p className="mb-5 text-center text-xs font-semibold text-gray-700 md:mb-2">
        ...
        >
          {(props) => (
            <Form
              autoComplete="off"
              className="p-5 text-black md:py-10 md:px-16"
            >
                    ...
                    {/* <div className="flex flex-col items-start justify-center">
                      <div
                        className={`w-72 md:w-80 ${
                          selectedValue
                            ? "mb-12 border-b-2 border-b-teal-600"
                            : apartmentSelected
                      ...
                      {!selectedValue && apartmentSelected && (
                        <div className="mb-12 flex w-80 items-start justify-start text-xs text-rose-600">
                    ...
                    <div>
                      ...
                      >
                        <Field
                          ...
                          maxLength="8"
                          autoComplete="off"
                          className="remove-default-focus peer h-10 w-[88%] border-b-2 border-b-teal-600 p-0 placeholder-transparent placeholder-shown:border-b-gray-400"
                        />
                        <label
                          htmlFor="totalArea"
                          className="absolute left-0 -top-3.5 text-xs text-teal-600 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-zinc-400 peer-focus:-top-3.5 peer-focus:text-xs peer-focus:text-teal-600"
              ...
              <AnimatePresence exitBeforeEnter>
                {activeStep === 2 && (
                  ...
                  >
                    ...
                    <div
                      className={`${
                        props.values.listingType === "rent" ? "mb-12" : "mb-0"
                      } inline-flex text-xs`}
                    >
