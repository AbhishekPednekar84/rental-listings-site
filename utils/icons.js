...
export const checkIconAltSmall = (
  <svg
    className="h-4 w-4"
    fill="none"
    stroke="currentColor"
...
//     <path
//       strokeWidth="2"
//       d="M9 8h6m-5 0a3 3 0 110 6H9l3 3m-3-6h6m6 1a9 9 0 11-18"
//     ></path>
//   </svg>
// );
...
export const petIcon = (
  ...
  >
    ...
    <circle cx="9" cy="5.5" r="2.5" fill="black" />
    <circle cx="15" cy="5.5" r="2.5" fill="black" />
    <circle cx="19.5" cy="9.5" r="2.5" fill="black" />
    <path
      fill="black"
...
export const areaIcon = (
  ...
  >
    ...
    />
    <path fill="#0D9488" d="M15 12h2V7h-5v2h3zm-3 3H9v-3H7v5h5z" />
  </svg>
);
...
export const parkingIcon = (
  ...
  >
    ...
    />
    <circle cx="6.5" cy="14.5" r="1.5" fill="#0D9488" />
    <circle cx="17.5" cy="14.5" r="1.5" fill="#0D9488" />
  </svg>
);
...
export const directionIcon = (
  ...
  >
    <g fill="#0D9488">
      <path d="M8 16.016a7.5 7.5 0 0 0 1.962-14.74A1 1 0 0 0 9 0H7a1 1 0 0 0-.962 1.276A7.5 7.5 0 0 0 8 16.016zm6.5-7.5a6.5 6.5 0 1 1-13 0a6.5 6.5 0 0 1 13 0z" />
      <path d="m6.94 7.44l4.95-2.83l-2.83 4.95l-4.949 2.83l2.828-4.95z" />
    </g>
  </svg>
);
